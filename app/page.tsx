...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#040d1a] text-white overflow-x-hidden">
      ...
      {/* ── NAV ── */}
      <nav className={`fixed top-0 inset-x-0 z-50 transition-all duration-300 ${scrolled ? "bg-[#040d1a]/90 backdrop-blur-xl border-b border-white/5 shadow-2xl" : ""}`}>
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="relative">
              ...
              <span className="absolute -top-1 -right-1 w-3 h-3 bg-emerald-400 rounded-full border-2 border-[#040d1a] animate-pulse" />
            </div>
            <div>
              <p className="font-black text-white text-base tracking-tight leading-none">MedAI Portal</p>
              <p className="text-[10px] text-blue-400 font-medium tracking-widest uppercase">Healthcare System</p>
            </div>
          </div>
          <div className="hidden md:flex items-center gap-8">
            {["Features", "Specialties", "About"].map((item) => (
          ...
          <div className="flex items-center gap-3">
            <button className="hidden sm:block text-sm text-slate-400 hover:text-white transition-colors font-medium px-4 py-2">
              Sign In
            </button>
            <Link href="/register">
              <button className="bg-gradient-to-r from-blue-600 to-cyan-500 hover:from-blue-500 hover:to-cyan-400 text-white text-sm font-semibold px-5 py-2.5 rounded-xl shadow-lg shadow-blue-500/25 transition-all duration-200 hover:shadow-blue-500/40 hover:scale-105">
                Register Patient
              </button>
            </Link>
          </div>
      ...
      <section className="relative z-10 pt-36 pb-24 px-6">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
            ...
            <button className="w-full sm:w-auto flex items-center justify-center gap-2.5 bg-white/5 hover:bg-white/10 border border-white/10 hover:border-white/20 text-white font-semibold px-8 py-4 rounded-2xl transition-all duration-200 text-base">
